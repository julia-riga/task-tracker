...
const translations = {
  ru: {
    ...
    healthCat: "Здоровье",
    otherCat: "Другое",
    themeStatusLight: "Светлая",
    themeStatusDark: "Тёмная",
    notifStatusOn: "Вкл",
    notifStatusOff: "Выкл",
    ...
    exportBtn: "Экспорт",
    importBtn: "Импорт",
    weeklyProgressTitle: "📈 Прогресс за неделю",
    statTotalLabel: "Всего",
    statCompletedLabel: "Выполнено",
    statActiveLabel: "Активных",
    statOverdueLabel: "Просрочено",
    calendarTitle: "Календарь",
    addTaskPlaceholder: "Что нужно сделать?",
    categorySelectPlaceholder: "📌 Категория",
    addBtnText: "Добавить",
    sortLabel: "Сортировка:",
    sortStatusDate: "Статус и дате",
    sortDeadline: "Дедлайну",
    ...
    newDeadlinePrompt: "Новый дедлайн (ГГГГ-ММ-ДД):",
    categoryPrompt: "Категория:",
    confirmDeleteTask: "Удалить задачу?",
    emptyTaskWarning: "Введите описание задачи",
    emptyTextWarning: "Текст не может быть пустым",
    taskAdded: "Задача добавлена",
    taskDeleted: "Задача удалена",
    taskUpdated: "Задача обновлена",
    overdueTaskCompleted: "Просроченная задача выполнена!",
    exportSuccess: "Экспортировано задач:",
    importConfirm: "Импортировать задачи? Текущие будут заменены.",
  ...
  en: {
    ...
    cleaningCat: "Cleaning",
    studyCat: "Study",
    workCat: "Work",
    healthCat: "Health",
    otherCat: "Other",
    themeStatusLight: "Light",
    themeStatusDark: "Dark",
    notifStatusOn: "On",
    notifStatusOff: "Off",
    ...
    newDeadlinePrompt: "New deadline (YYYY-MM-DD):",
    categoryPrompt: "Category:",
    confirmDeleteTask: "Delete task?",
    emptyTaskWarning: "Enter task description",
    emptyTextWarning: "Text cannot be empty",
    taskAdded: "Task added",
    taskDeleted: "Task deleted",
    taskUpdated: "Task updated",
    overdueTaskCompleted: "Overdue task completed!",
    exportSuccess: "Exported tasks:",
    importConfirm: "Import tasks? Current will be replaced.",
    importSuccess: "Imported tasks:",
...
function addNewCategory() {
  ...
  if (!name) {
    showNotification(t("enterCategoryName"), "warning");
    return;
  }
...
function requestNotificationPermission() {
  ...
  if (Notification.permission !== "denied") {
    ...
    showNotification(t("notificationsBlocked"), "warning");
  }
  return false;
}
...
function handleListClick(e) {
  ...
  if (e.target.classList.contains("task-check")) toggleTaskCompletion(id);
...
function initEventListeners() {
  ...
  categoryListEl.addEventListener("click", (e) => {
    ...
    if (btn) deleteCategory(btn.dataset.key);
  });
